	...
	if (
		...
		if (!timerset) {
			timer = setTimeout(function() {
				var index = $(".lock .stage li.active")
					.addClass("done")
					.index();
				...
				if (!$(".lock .stage li.active").length) {
					...
					alert(
						"We hired a hacker. We didn't hire a lockpick. Get to hacking! Don't cross us again.\nGOING TO HAVE SOMETHING LOAD THAT CAN LEAD TO DIRECTORY TRAVERSAL HERE"
					);
				}
			}, 3000);
			timerset = true;
